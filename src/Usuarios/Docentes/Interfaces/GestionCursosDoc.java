...
import Usuarios.Docentes.GestionRecursos.CargaGestionCursos;
...
public class GestionCursosDoc {
    private final CargaGestionCursos carga = new CargaGestionCursos();
    ...
    public GestionCursosDoc() throws SQLException {
